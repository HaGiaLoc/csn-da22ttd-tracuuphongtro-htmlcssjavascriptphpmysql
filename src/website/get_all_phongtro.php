...
// Sử dụng lại hàm createPhongTroElement từ get_phongtro.php
    ...
    <article class="phongtro" data-id="' . $phong['maPhongTro'] . '">
        <a href="index.php?page=phongtro&id=' . $phong['maPhongTro'] . '" class="lien-ket-phong-tro">
            <div class="hinh-anh-review">
                <img src="' . (empty($phong['anhDaiDien']) || !file_exists($phong['anhDaiDien']) ? "images/default.png" : $phong['anhDaiDien']) . '" alt="Hình ảnh phòng trọ">
            </div>
            <div class="details">
                <div class="thong-so">
                ...
                <div class="thong-tin">
                    <div class="time-rating">
                        ...
                        <div class="rating">
                            ' . $ratingHtml . '
                            <span class="score-text">(' . number_format($score, 1) . ' / 5) (' . $phong['soLuotDanhGia'] . ')</span>
                        </div>
                    </div>
